...
export default function AboutPage() {
  ...
  return (
    <div style={{ ...ui.page, lineHeight: 1.7 }}>
      ...
      <p style={pStyle}>
        These bands are calibrated for intermediate riders, and informed by published wind-speed guidance for the sport. 12 mph is the practical minimum to reliably get up on the foil, and 28 mph is roughly where most intermediate riders start to struggle without smaller gear. The hourly chart shows all 24 hours (hours outside 6am to 8pm are shaded), but every summary on this site, including which spots look good, best windows, and day-tab highlights, only ever counts daylight hours toward "good."
      </p>
