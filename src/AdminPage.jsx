      ...
      <div style={{ maxWidth: 400, margin: '80px auto', padding: '0 24px' }}>
        ...
        <form onSubmit={login}>
          <input
            ...
            style={{ width: '100%', padding: '9px 10px', border: `1px solid ${COLORS.paperLine}`, borderRadius: 4, fontSize: 14, marginBottom: 12, boxSizing: 'border-box' }}
          />
          <button
            type="submit"
            disabled={loading}
        ...
        <div key={s.id} style={{ border: `1px solid ${COLORS.paperLine}`, borderRadius: 6, padding: 16, marginBottom: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 12 }}>
            <button
              ...
              style={{ background: COLORS.go, color: '#fff', border: 'none', padding: '6px 14px', borderRadius: 4, cursor: 'pointer', fontWeight: 600, fontSize: 13 }}
            >
              Approve
            </button>
            <button
              onClick={() => review(s.id, 'reject')}
              style={{ background: 'none', color: COLORS.inkSoft, border: `1px solid ${COLORS.paperLine}`, padding: '6px 14px', borderRadius: 4, cursor: 'pointer', fontSize: 13 }}
            >
              Reject
            </button>
          </div>
